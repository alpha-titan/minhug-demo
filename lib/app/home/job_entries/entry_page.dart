...
class EntryPage extends StatefulWidget {
  const EntryPage({@required this.database, @required this.appointment, this.entry});
  final Appointment appointment;
  final Entry entry;
  final Database database;

  static Future<void> show({BuildContext context, Database database, Appointment appointment, Entry entry}) async {

    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) =>
            EntryPage(database: database, appointment : appointment, entry: entry),
